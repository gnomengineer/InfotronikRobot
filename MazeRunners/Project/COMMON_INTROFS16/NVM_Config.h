...
#define NVMC_STEPS_DATA_START_ADDR		(NVMC_REFLECTANCE_END_ADDR+1)
#define NVMC_STEPS_DATA_SIZE			(3*2)
#define NVMC_STEPS_END_ADDR				(NVMC_STEPS_DATA_START_ADDR+NVMC_STEPS_SIZE)
