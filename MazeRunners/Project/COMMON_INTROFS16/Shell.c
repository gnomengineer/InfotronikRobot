...
static CLS1_ConstStdIOType CopyStdio = {
  (CLS1_StdIO_In_FctType)CopyStdIn, /* stdin */
  (CLS1_StdIO_OutErr_FctType)CopyStdOut, /* stdout */
  (CLS1_StdIO_OutErr_FctType)CopyStdErr, /* stderr */
  CopyKeyPressed /* if input is not empty */
};
#endif
